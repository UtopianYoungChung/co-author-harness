...
The checklist applies to S2, S4, S4.5, and any post-v0.10.0 stage that touches a phase-runner. S1, S3, and S6 ship new manually-invokable skills (no `run-phase-N` Step edit) and are exempt; S5 is documentation-only and exempt.
