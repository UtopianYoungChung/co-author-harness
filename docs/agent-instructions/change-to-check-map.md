...
| Version or host identity (`version.json`, host manifests) | `python scripts/version-check.py`; `python scripts/manifest-coherence-check.py`; `python scripts/ssot-check.py` | `python scripts/version_policy_smoketest.py` | No |
