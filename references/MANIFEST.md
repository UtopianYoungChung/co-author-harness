...
| `policies/reader_accessibility.v1.json` + `generated/reader_accessibility_policy_view.md` + `schemas/reader_accessibility_profile.schema.json` + `schemas/reader_accessibility_candidates.schema.json` + `schemas/check8_evidence.schema.json` | Single machine-readable policy, its exact generated human-readable numeric view, and strict candidate/adjudicated-evidence contracts; hashes are stored externally | Every Ph2–Ph4 Check 8 dispatch, F1, and MF-POLICY validation |
