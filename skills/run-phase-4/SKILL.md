...
cardinality, ordering, and typed suppression, before writing. Legacy readability grants no shipment, application,
or terminal authority. `/run-finalize` is canonical; this file retains legacy
