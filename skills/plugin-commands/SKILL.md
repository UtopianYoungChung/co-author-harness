...
| `/run-phase-1` | T1 Plan & Draft — Planner bootstraps the 18-field section state; Generator drafts under the declared P-stage register. No Evaluator; no Self-T1 Verdict (retired at v0.7.0). | First rung for a new section or section whose ceiling is T1. |
