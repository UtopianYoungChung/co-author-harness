...
- **Ph1 bounded engagement.** After every M1-M4 Ph1 Generator publication, run the independent `review` centroid derivation and complete the evaluation-side all-drafts governance contract over the exact bytes. This pass covers centroid, D-STYLE, grammar/mechanics, citation, grounding, reader accessibility, deterministic checks, and applicable overlays. It does not replace the full local-scope Ph2 pass. Full seven-step judgment + complete SAFEGUARD begins at Ph3; Ph4 is the strict superset.
...
|---|---|---|---|---|---|
| **Ph1 Plan & Draft** | **Dormant.** If errantly dispatched, return `E-EVALUATOR-PH1-DORMANT` to the Planner and write zero Evaluator artifacts. | — | — | No | None |
