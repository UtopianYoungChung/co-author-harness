...
Based on the section's `current_phase` and project state, decide which agents to dispatch. At Ph1, dispatch the Evaluator for the bounded all-drafts centroid and governing-policy evaluation after every Generator publication; broader revision-maturity review remains a Ph2+ responsibility.
